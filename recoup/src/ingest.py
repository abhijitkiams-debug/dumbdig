...
SYNONYMS = {
    ...
    "next_installment_amount": ["next_installment_amount", "nextinstallment", "emi", "emiamount", "installment", "nextduamount"],
    "past_due_amount": ["past_due_amount", "pastdue", "overdue", "arrears", "amountoverdue", "overdueamount", "posoverdue"],
