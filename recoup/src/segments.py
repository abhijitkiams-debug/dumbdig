...
SEGMENT_DEFS = [
    ...
    {"id": "hot_recovery",  "name": "Hot recovery — action now",
    ...
    {"id": "persuadable",   "name": "Persuadable — negotiate",
    ...
    {"id": "escalate_field","name": "Escalate — field & legal",
    ...
    {"id": "monitor",       "name": "Monitor — low-touch nurture",
